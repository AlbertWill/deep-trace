...
This skill exports a Deep-Trace strategy to **all major trading platforms** in one go.
...
```pinescript
// This strategy was generated by Deep-Trace
...
```mql5
//+------------------------------------------------------------------+
//| Generated by Deep-Trace                                         |
//+------------------------------------------------------------------+
#property copyright "Deep-Trace"
...
When generating code, map Deep-Trace instrument codes appropriately:

| Deep-Trace | TradingView | 通达信/同花顺 | MT5 |
|-------------|-------------|---------------|-----|
...
- [ ] Comment header notes the original Deep-Trace run_id and instrument
