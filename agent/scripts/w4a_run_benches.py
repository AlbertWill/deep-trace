...
Output:
    ~/.deep-trace/reports/alpha_bench_*.html      — per-run HTML reports
    ~/.deep-trace/reports/bench_<zoo>_<uni>.json  — per-run raw results
    ~/.deep-trace/reports/bench_summary.json      — aggregate summary
...
REPORTS_DIR = Path.home() / ".deep-trace" / "reports"
