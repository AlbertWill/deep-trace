...
2. Use the [GitHub Security Advisory](https://github.com/HKUDS/Deep-Trace/security/advisories/new) to report privately.
...
This policy applies to the [HKUDS/Deep-Trace](https://github.com/HKUDS/Deep-Trace) repository.
